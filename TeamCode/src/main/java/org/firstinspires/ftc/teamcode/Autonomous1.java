...
public class Autonomous1 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        robot.ElderWand((100)); // lower ElderWand
        encoderDrive(0.3, 0.3,295,295,4); // move out
        encoderTurn(0.3,-244,244,4); // turn
        encoderDrive(-0.3, -0.3,-300,-300,4); // move back and maybe get team element
        sleep(250); // stop briefly
        encoderDrive(-0.3, -0.3, 850,850,4); // move forward to the end of the tile
        sleep(250); // stop briefly
        robot.ElderWand((2521)); // raise the Elder Wand

        encoderDrive(0.1, 0.1, 50, 50, 4); // go forward again
        encoderTurn(0.3,-190,190,4); // turn to face carousel
        encoderDrive(0.3,0.3, 120,120,2); // go towards carousel

        robot.setMotorPowers(0.1,0.1,0.1,0.1); // snug up the the carousel by time
        sleep(1000);
        robot.stop();
        ...
        encoderDrive(-0.4, -0.4, -1375,-1375,3); // back up to about the center of the field
        encoderTurn(0.3,-313.19444444444, 313.19444444444, 4); // turn to go straight
        encoderDrive(0.4, 0.4, 900, 900, 5);
